...
export interface ApiOrderItemOrderItem extends Schema.CollectionType {
  ...
  attributes: {
    productNameSnapshot: Attribute.String & Attribute.Required;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'products';
    displayName: 'Product';
    description: 'Peptide products for the storefront';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiVariantVariant extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'variants';
    displayName: 'Variant';
    description: 'Product variants with different sizes/prices';
  };
  options: {
    draftAndPublish: false;
  };
